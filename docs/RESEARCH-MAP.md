...
## Current decision edge — #537 theory only, no P0 production

The exact chain `source -> j_in,j_out -> J_grad -> original pooled-root/slope-normalized U` remains the organizing question. Its requested #154 test and both independent #334 interventions are complete; their named failed policies are stopped. #537 is the sole P0 theory task with no random budget; #154/#334/#337 remain P1 and #539/#542 are P2 support/follow-up.
...
The [#537 exact audit](https://github.com/LightChainr/Matching-One/blob/ec3941b03b2694e827db1cba34766a82e6146a5a/notes/p337-thermal-pivotal-gate-audit.md) proves that the thermal covariance derivative has kernel-reconnection and original rank/readout-pivotal channels. Its N25 preflight and the later #544/#545 finite wedges reject pure-thermal rank one at their declared finite scopes; #544's exact broad L4/L5 populations also support a local `L^-4` thermal-orthogonal correction hypothesis. The [scope decision](https://github.com/LightChainr/Matching-One/blob/090cdc80c76b9ca1f79309cedbbebae4190ccb12/notes/p537-finite-rank-one-decision-20260901.md) records why neither Draft is the complete formal ordinary/no-extra/original-U certificate and why two sizes are not an exponent. The live theory object remains the root-conditioned mixed Hessian `partial_u partial_epsilon Yhat=T_N/D=J_N/A_N`. The next edge is physical: test whether one defect can change both slow variables with nonzero full Schur weight. No new geometry or random readout is queued.
...
Post-cleanup Drafts #530-#533 and issues #539/#542 are explicitly indexed as P2 support/candidates. #530/#531 reuse the exact N25 dependency block for method/oracle analysis; #532 is finite algebra. At #533 head `5aa929a6ef4ff92d71f6f36097b763c05ad71ab8`, C1 consists of exact relaxed-axis controls: the all-`w` Catalan/Toeplitz one-particle identity, immediate `EW/WE` retracing prohibition, a legal nonlocal one-west counterexample, and the conditional `pq` consequence of an already-proved exponential two-gap kernel. The actual physical collar/kernel, physical `w>=2`, rank-one/common-coordinate and thermal/root/original-U map, and uniform full-model remainder remain C0; `410015f5`/`2690f665` ancestry and the recorded `a*s`, control-character and adjacent-hole-order repairs remain outstanding. #542 stays open for those analytic follow-ups without a random budget. None is an execution queue.

Later PRs #544/#545 are also fixed-head support, now closed and unmerged. #544 establishes an explicit N25 radius-one collar coarsening with a nonzero pooled-root minor and a reproducible broad L4/L5 scale fingerprint, but lacks the global joint-component/no-extra certificate. #545 contributes an arbitrary-radius broad pointwise witness and exact axis-L4 arithmetic, while its landing-subblock conditioning is not the complete original-U pooled-root Schur map. The [scope decision](https://github.com/LightChainr/Matching-One/blob/090cdc80c76b9ca1f79309cedbbebae4190ccb12/notes/p537-finite-rank-one-decision-20260901.md) retires further finite rank-one rescue and routes #537 to the one-defect diagonal-edge falsifier.


**P337 finite transmission and critical spatial boundary are now closed at their declared levels.** [Homogeneous N50](https://github.com/LightChainr/Matching-One/blob/ef3b2c68f824e29421747c805ea7a505aca41908/experiments/p337-homogeneous-n50-20260831/RESULT.md) gives original U=1.0615603877 and V_S=+0.0543457827. The [canonical local pair](https://github.com/LightChainr/Matching-One/blob/2ba8863f75e0ced211b7b5442e8cddbe2fbd3deb/notes/regular-pair-interaction-result.md) has direct Q1 response zero and fixed mixed response -0.04503611398. The [fresh spatial blocks](https://github.com/LightChainr/Matching-One/blob/a237968f1d7a82d26b46e83c58179dbba7f1a908/notes/regular-pair-spatial-transmission-result.md) reject finite zero transmission at L64/distance16 without fitting an exponent. The [complete N25 joint response](https://github.com/LightChainr/Matching-One/blob/410015f5505dc2d8ca0e9ac904f656a4adc9fe86/notes/regular-pair-joint-transmission-result.md) is J2=-0.0055194314248394015; both adjacent and nonadjacent parts are strictly negative, rejecting additive-linear and NN-contact-only closures. Finally, the [critical square-site theorem](https://github.com/LightChainr/Matching-One/blob/eed2190c04b67084ab5aef5827e00377853a0bca/notes/p337-critical-spatial-summability.md) proves E_pc|g_xy|<=C d^(-2-eta) for some eta>0, hence a uniformly summable raw spatial kernel and vanishing macroscopic tail. It does not bound full U or apply automatically to the finite p_ref/root. Stop distance grids, exponent fits, completion scans and uniform-J2 repeats. #537 owns the two-channel thermal/pivotal theory gate, alongside the separate fixed-m phase/sector control; no production is queued.
