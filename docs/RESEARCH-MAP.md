...
Later PRs #544/#545 are also fixed-head support, now closed and unmerged. #544 establishes an explicit N25 radius-one collar coarsening with a nonzero pooled-root minor but lacks the global joint-component/no-extra certificate. #545 contributes an arbitrary-radius broad pointwise witness and exact axis-L4 arithmetic, while its landing-subblock conditioning is not the complete original-U pooled-root Schur map. The [scope decision](https://github.com/LightChainr/Matching-One/blob/8d228aa4f9de73821d1f0f8ad4f1c3b5a5205024/notes/p537-finite-rank-one-decision-20260901.md) retires further finite rank-one rescue and routes #537 to the one-defect diagonal-edge falsifier.
