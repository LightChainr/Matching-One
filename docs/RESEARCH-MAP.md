...
The [#537 exact audit](https://github.com/LightChainr/Matching-One/blob/ec3941b03b2694e827db1cba34766a82e6146a5a/notes/p337-thermal-pivotal-gate-audit.md) proves that the thermal covariance derivative has kernel-reconnection and original rank/readout-pivotal channels. Its [N25 landing preflight](https://github.com/LightChainr/Matching-One/blob/ec3941b03b2694e827db1cba34766a82e6146a5a/experiments/p537-landing-matrix-preflight-20260901/REPORT.md) finds every `2 x 2` minor nonzero under an explicit six-block clean-two-bridge contract, so a universal thermal-rank-one cancellation is false. The live theory object remains the root-conditioned mixed Hessian `partial_u partial_epsilon Yhat=T_N/D=J_N/A_N`. The next edge is semantic: freeze whether ordinary/no-extra includes that port event, then either retire rank one or rerun one minimally extended exact z-local audit. No new geometry or random readout is queued.
