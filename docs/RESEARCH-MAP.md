...
The [#537 exact audit](https://github.com/LightChainr/Matching-One/blob/2785e3bba2eb6a70fd4f2d390d3b3c2701a99d85/notes/p337-thermal-pivotal-gate-audit.md) proves that the thermal covariance derivative has two channels: kernel reconnection and original rank/readout pivotal. Bell-8 and the complete N13 checks show sign-changing local joins, including 312 flips that preserve shared-component count; omitting the readout term reverses the N9/N10/N13 sign. The live theory object is the root-conditioned mixed Hessian `partial_u partial_epsilon Yhat=T_N/D=J_N/A_N`, equivalently a signed Schur covariance that retains both channels and root motion. Its first falsifier is the projected ordinary-four-arm landing matrix: any nonzero `2 x 2` minor stops the rank-one cancellation route. No new geometry or random readout is queued.
...
Post-cleanup Drafts #530-#533 and issue #539 are explicitly indexed as P2 support/candidates. #530/#531 reuse the exact N25 dependency block for method/oracle analysis; #532 is finite algebra. At #533 head `a7680426768ca93ead1fca9446ae86ca1fc15ced`, the Bessel-capillary sign is C1 local/conditional; dependency ancestry, the omitted `a*s` term, a uniform full-lattice remainder and the adjacent-hole order correction keep the full theorem P2/C0. None is an execution queue.
