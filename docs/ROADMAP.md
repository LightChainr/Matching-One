...
The integrated control-plane snapshot is `main@cc3c204`. It inventories 59 score paths: 28 direct typed entrypoints, 27 wrapper-covered frozen kernels, 3 migration-required paths and 1 non-applicable utility. Later exact controls—including the #370 envelope and recurrence/Hankel/ideal/realization framework through `cc3c204`—do not change scorer counts or production evidence. Draft PR #267 inventories 65 paths: 28 direct, 27 covered, 9 migration-required and 1 utility. Semantic adoption is a composability layer, not a scientific grade, permission or task lock.
...
- **Semantic control plane:** `main@cc3c204b94b389eeb0eb91dbac35d6534c7d4586` inventories 59 paths: 28 direct, 27 covered, 3 migrations and 1 utility; Draft PR #267 inventories 65 = 28 + 27 + 9 + 1. Exact controls and framework components through the current main do not change scorer counts or production evidence.
