...
Merged PR #341 types the C4 holdout, PR #344 types both Issue43 kernels, PRs #345/#346 type the existing P50/P48 scorers and PR #347 composes their derived inventory; none changes data, score or scientific priority. The underlying model chronologies remain what they were, while these semantic gates are post-score and create no evidence votes.
...
- **Semantic control plane:** P50/P48 wrappers and composition PR #347 are on main; the live corpus is 44 paths, 13 direct, 12 covered, 18 migrations and 1 utility. PR #339 remains a synthetic-only odd-jet primitive and PR #342 a resource gate. None is new scientific evidence. Migration changes future composability, not historical evidence role; the next layer must record units, model/harmonic, size map, chronology and dependencies.
