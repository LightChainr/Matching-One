...
The requested #154/#334 blocks have delivered their decisions. #537 is the sole P0 theory task and has no random-production budget. #154/#334/#337 remain open P1 research questions; #539 is P2 reproducibility support.
...
The post-cleanup Drafts #530-#533 and issue #539 are P2 support/candidates, not competing priorities. #530/#531 provide oracle/method diagnostics on the existing exact N25 block; #532 preserves finite two-bridge algebra. At #533 head `a7680426768ca93ead1fca9446ae86ca1fc15ced`, the positive Bessel-capillary `J_1(c)` identity is C1 local/conditional, while the full theorem remains P2/C0 because dependency ancestry, the omitted `a*s` root-chart term and a uniform full-lattice remainder are unresolved; its adjacent-hole order also needs correction from `O(N a^4)` to `O(N a^3)`. None changes the two live theory questions.
