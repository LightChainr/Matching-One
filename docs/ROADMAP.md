...
Main also has a coherent 200-descriptor/952-map registry. Through `79c9c22`, the live corpus contains 54 paths: 23 direct typed entrypoints, 22 wrapper-covered frozen kernels, 8 migrations and 1 utility. The newest replays add prequential, P231 and v14 scalar-root coverage without modifying any frozen kernel, numerical result or scientific conclusion. This is a semantic transport layer, not a new evidence grade; topology typing does not yet type every derived response. `Migration_required` does not invalidate a result.
...
Merged PR #341 types the C4 holdout, PR #344 types both Issue43 kernels, and later wrappers through PR #361 now include prequential, P231 and v14 scalar-root replay; none changes data, score or scientific priority. The prequential channel-mismatch row remains excluded, the P231 C-only view remains shared retrospective evidence and the v14 implicit root remains a response coordinate. The exact parametric, log-odds and Pell artifacts are bounded method or regression contracts rather than physical evidence.
...
- **Semantic control plane:** main through `79c9c22` inventories 54 paths: 23 direct, 22 covered, 8 migrations and 1 utility. PRs #339/#349/#354 are synthetic exact primitives and PR #351 is a bounded exact regression; PR #342 remains a resource gate, while PRs #359/#360/#361 are frozen semantic replays. None is new scientific evidence. Migration changes future composability, not historical evidence role; the next layer must record units, model/harmonic, size map, chronology, response semantics and dependencies.
