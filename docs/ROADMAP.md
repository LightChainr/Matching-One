...
**Next decision output:** strengthen the N112 constraint or select a nondegenerate completion covector; do not repeat N60. Once the source plane is resolved, reuse its transported basis for primitive Z5 `113/122` fusion. This is a topology-typed multi-character question, not another ordinary H4/H8/H12 vote.
