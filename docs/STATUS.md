...
**The finite rank-one research decision is complete.** The [N25 preflight](https://github.com/LightChainr/Matching-One/blob/ec3941b03b2694e827db1cba34766a82e6146a5a/experiments/p537-landing-matrix-preflight-20260901/REPORT.md) first gave nonzero minors under an explicit six-block clean-two-bridge contract. PR #544 `e21f6220` then produced a strictly positive `+2.6904188461441777e-14` minor for an N25 radius-one collar after axis/tilted pooled-root Schur processing; its complete fibres and hashes were independently reproduced. PR #545 `697fa6fc` supplied an arbitrary-radius broad pointwise witness and an exact axis-L4 wedge `-533831111/140737488355328` with a Sturm root-interval certificate.

The [independent scope audit](https://github.com/LightChainr/Matching-One/blob/8d228aa4f9de73821d1f0f8ad4f1c3b5a5205024/notes/p537-finite-rank-one-decision-20260901.md) prevents overclaiming. #544 lacks the global `x+y+z` component identity/no-extra flag and collapses Bell transitions in its final column; #545 uses broad landing semantics and re-estimates `beta/S` inside the landing subblock, so its reduced identities are not the complete original-U pooled-root Schur summand. Its JSON files are semantically, but not byte, reproducible. Both Drafts are closed as unmerged assets. Their reliable fixed-head results retire finite pure-thermal rank-one rescue as a research strategy, without proving a nonzero infinite-volume limit.
