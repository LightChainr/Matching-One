...
- **P2：其他开放Issue。** 包括#275/#419/#370/#398/#1/#13；保留问题与已有成果，按需支持，不默认追加大样本、设备租赁、通用证明器或同类证书。

2026-08-31两个独立实验交付后的现场复查：开放Issue已由并行仓库操作进一步减少到83，优先级为P0=0/P1=7/P2=76。本任务最初关闭的13项列于上表，不把后续并行减少也计为本任务关单；动态数量以GitHub筛选为准。
