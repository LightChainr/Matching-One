...
1. **Run a live lifecycle drift pass at the start and end of each work block.** Compare open PR head/state with the registry and compare latest `origin/main` with the navigation base. Main is pinned here at `42c1563`; #345/#346/#347 are integrated, while P321/P334/P337/P250/P333/two-observer/P158 remain separately classified branch-only objects. Treat drift as routine state change rather than wait for another cleanup.
...
4. **Treat semantic adoption as a composability layer, not a scientific grade.** Both P50/P48 wrappers and their #347 composition repair are on main. The live 44 paths are 13 direct, 12 covered, 18 migrations and 1 utility; this changes no scorer, score or evidence. Typed replay should preserve old numbers and never require new production.
...
| descriptor registry and scorer-adoption inventory | `main_integrated` through composition PR #347 / `42c1563`; live 44/13/12/18 plus one utility and no new science |
