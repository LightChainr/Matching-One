...
def hnf_matrices(minimum_order: int = 2, maximum_order: int = 12) -> list[Matrix]:
...
def build_artifact() -> dict[str, Any]:
    ...
    assert total_paths == 13961736918
    ...
    return {
        ...
        "status": (
            ...
            else "no_counterexample_through_index_12"
        ),
        "order_range": [2, 12],
        ...
        "geometries": rows,
        "claim_boundary": {
            "proved": "all permutations of every HNF quotient of index 2 through 12",
            "not_proved": "index 13 and above or an unrestricted degenerate-quotient theorem",
        },
    }
...
def render_markdown(artifact: dict[str, Any]) -> str:
    lines = [
        ...
        "",
        "Every permutation of every two-dimensional HNF quotient of index 2 through 12 is exhausted.",
        "",
    ...
    lines.extend(
        [
            ...
            "## Boundary",
            "",
            "The result is exhaustive only through index 12. It does not prove an unrestricted theorem",
