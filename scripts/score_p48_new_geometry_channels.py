#!/usr/bin/env python3
"""Score the frozen P48 pure laws on the prospective N=185/265 geometries.
...
This script deliberately scores the intrinsic-center P48 projectors.  It must
not be confused with the separate fixed-coordinate P31/P43 `either/even`
DeltaS observable.
"""
...
def score(source_summary: dict, target_payloads: Dict[int, dict]) -> dict:
    ...
    output = {
        ...
        "important_observable_boundary": (
            "P48 intrinsic-center S/D projectors; not the fixed-coordinate "
            "P31/P43 either/even DeltaS observable"
        ),
        "channels": {},
    }
