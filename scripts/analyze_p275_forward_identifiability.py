...
def build_report(
    ...
    return {
            ...
            "fixed_H8_alias_radial_transplant_kappa_2_pow_minus_11_over_8": {
                **fixed_h8_alias,
                "hypothesis_provenance": {
                    ...
                    "superseded_by_heldout_commit": h8_contract["superseded_by_heldout_commit"],
                    "exact_closure_commit": h8_contract["exact_closure_commit"],
                },
                ...
                "claim_boundary": "historical_parameterization_exclusion_only_the_N65_H8_label_is_superseded_by_the_N145_H0_gate_and_exact_Gaussian_unit_rotation_theorem",
            },
        ...
        "boundaries": [
            ...
            "the_fixed_H8_alias_radial_transplant_is_a_post_reveal_historical_diagnostic",
            "the_N145_H0_gate_and_exact_unit_rotation_theorem_supersede_the_N65_H8_label",
...
def markdown_report(report: Mapping[str, Any]) -> str:
    ...
    lines = [
        ...
        f"nominal `p={h8['chi_square_survival_p']:.6g}`).  This remains a valid exclusion",
