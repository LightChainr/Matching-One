...
Thermal normalization does not remove the known derivative drift: the primary constant-amplitude score is `10.3161 / 2 df`. Thus the bare `N^-13/8` pivotal-H4 law is not an adequate precision model for this block.
