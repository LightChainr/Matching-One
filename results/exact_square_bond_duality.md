...
These rationals are locked by `tests/test_square_bond_duality_exact.py`.
The table is the verbatim script output at commit time.
...
Same-N Gaussian orientation production for issue #42 is not contained here.
