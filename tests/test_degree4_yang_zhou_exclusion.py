...
INTERVAL_ID = "yang-zhou-2024-corrected"


class DegreeFourYangZhouExclusionTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_complete_quartic_exclusion(self):
        row = self.result["interval_result"]
        self.assertEqual(row["primitive_quartics_covered"], 157_309_446_881)
        ...
        self.assertEqual(row["distinct_roots_in_interval"], 0)
    ...
    def test_tampering_fails_closed(self):
        ...
        changed["interval_result"]["root_filter_candidates"] = 1
