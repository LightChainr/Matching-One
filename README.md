...
Semantic adoption is tracked orthogonally to these five scientific coordinates. Main through `8ba849c` inventories 51 score paths: 20 direct typed entrypoints, 19 wrapper-covered frozen kernels, 11 migration-required paths and 1 non-applicable utility. PRs #348/#350/#352/#353/#355/#357 type six existing scorer families while replaying unchanged kernels; they add no samples, refits, scores or evidence rows. The wrappers strictly type the topology observable, while units, model space, implicit-root or annihilator response, size-map, chronology and dependency fields still belong in a second scorer contract. These labels guide future composability; they never demote historical evidence or change task permission.
