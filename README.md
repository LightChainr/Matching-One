...
Semantic adoption is tracked orthogonally to these five scientific coordinates. Main through `79c9c22` inventories 54 score paths: 23 direct typed entrypoints, 22 wrapper-covered frozen kernels, 8 migration-required paths and 1 non-applicable utility. The newest typed replays now also cover the frozen prequential ledger, P231 C/Q/S diagnostic and v14 scalar-root projector. They bind descriptors, registered maps, ordering, covariance and chronology without adding samples, refits, scores or evidence rows: the historical channel mismatch remains excluded, P231 remains retrospective shared evidence, and the H4-null root does not identify a continuum field. Units, model space, implicit-root or annihilator response, size-map and dependency fields still belong in a second scorer contract. These labels guide future composability; they never demote historical evidence or change task permission.
