...
- **#537, theory only:** the [exact thermal/landing audit](https://github.com/LightChainr/Matching-One/blob/ec3941b03b2694e827db1cba34766a82e6146a5a/notes/p337-thermal-pivotal-gate-audit.md) first proves that `d_p Cov(O,a)` has kernel-reconnection and original rank/readout-pivotal channels. Its [finite preflight](https://github.com/LightChainr/Matching-One/blob/ec3941b03b2694e827db1cba34766a82e6146a5a/experiments/p537-landing-matrix-preflight-20260901/REPORT.md) then gives six nonzero minors for each C4 orbit and their sum under an explicit six-block clean-two-bridge contract; the summed P4/root minor is `-2.4843232721775393e-5`. This kills a universal thermal-rank-one story under that auditable contract. The only next action is to freeze what “ordinary four-arm/no-extra-branch” means and decide whether it includes this event; no new N, random block or five/six-arm program is authorized first.
