...
The main line contains three complementary finite checks. PR #282 identifies `K_minus/K_plus` with the first and second essential-H1 births; PR #283 reconstructs `P0/P1/P2` and the mean rank-one lifetime; PRs #284-#287 and now merged PR #292 exhaust the short-period quotient frontier through index 10. The cached/subset-DP result covers 86 HNF representatives, 70,690,518 filtrations, 31,068 cached subsets and 262,901,744 rank-one plateau steps with no birth, reflection, rank-sum, reconstruction or line failures; maximum `iota` remains one with no path evolution. This is a `main_integrated` finite frontier, not a theorem for index 11 and above or every degenerate quotient. The older production rank archive still lacks the plateau line `ell`, Smith saturation index `iota` and local birth mark.
