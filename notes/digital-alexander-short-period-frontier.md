...
oracle enumerates every such representative for `2<=n<=11` and constructs the square NN and matching
NN+diagonal quotient graphs. This gives 98 quotient geometries and 549,692,118 complete filtrations.
...
This is an exhaustive finite frontier through index 11 only. A null search does not prove all degenerate
